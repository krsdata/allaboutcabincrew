...
jQuery(document).ready(function($) {
     ...
     */
    upload_media_image('.ep-upload-button');
    delete_media_image('.ep-delete-button');
     ...
     */
    $( '.ep-meta-options-wrap .buttonset' ).buttonset();

    /**
     * Meta tabs and its content
     */
    var curTab = $('.ep-meta-menu-wrapper li.active').data('tab');
    $('.ep-metabox-content-wrapper').find('#'+curTab).show();
    
    $('ul.ep-meta-menu-wrapper li').click(function (){
        var id = $(this).data('tab');
        
        $('ul.ep-meta-menu-wrapper li').removeClass('active');
        $(this).addClass('active')
        
        $('.ep-metabox-content-wrapper .ep-single-meta').hide();
        $('#'+id).fadeIn();
