...
add_action( 'add_meta_boxes', 'eight_paper_post_meta_options' );

if( ! function_exists( 'eight_paper_post_meta_options' ) ):
 function  eight_paper_post_meta_options() {
  add_meta_box(
    'eight_paper_post_meta',
    esc_html__( 'Post Meta Options', 'eight-paper' ),
    'eight_paper_post_meta_callback',
    'post',
    'normal',
    'high'
  );
 ...
 */
if( ! function_exists( 'eight_paper_post_meta_callback' ) ):
	function eight_paper_post_meta_callback() {
    ...
    wp_nonce_field( basename( __FILE__ ), 'eight_paper_post_meta_nonce' );
    ?>
 ...
 * @since 1.0.8
 */
add_action( 'save_post', 'eight_paper_save_post_meta' );

if( ! function_exists( 'eight_paper_save_post_meta' ) ):

  function eight_paper_save_post_meta( $post_id ) {
