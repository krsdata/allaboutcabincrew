<?php
	...
	if( !empty($this->pro_plugins) ) {
		?>
		<h3 class="recomplug-title choose-demo-title"><?php echo esc_html($this->strings['pro_plugin_title']); ?></h3>
					...
					<div class="recom-plugin-wrap">
						<div class="plugin-img-wrap">
							...
							<div class="version-author-info">
								<span class="version"><?php echo esc_html__('Version ', 'eight-paper') . esc_html($plugin['version']); ?></span>
	...
	if( !empty($this->free_plugins) ) {
		?>
		<h3 class="recomplug-title choose-demo-title"><?php echo esc_html($this->strings['free_plugin_title']); ?></h3>
		<p><?php echo esc_html($this->strings['free_plugin_description']); ?></p>
			...
			?>
				<div class="recom-plugin-wrap">
					<div class="plugin-img-wrap">
						<img src="<?php echo esc_url($icon_url); ?>" />
						<div class="version-author-info">
							<span class="version"><?php echo esc_html__('Version ', 'eight-paper') . esc_html($info->version); ?></span>
							<span class="seperator">|</span>
