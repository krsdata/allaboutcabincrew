<?php
	...
	if($show_success_notice) :
		...
		<div class="action-tab success">
			...
			<a class="button button-primary" href="<?php echo esc_url(admin_url('themes.php?page=welcome-page')); ?>">
					...
					<div class="action-tab warning">
						<h3>
							<?php
								...
								echo esc_html__('Install', 'eight-paper'). ' : '. esc_html($info->name). esc_html__('Plugin', 'eight-paper');
							?>
						</h3>
