<?php
if(!class_exists('Eight_Paper_Welcome')) :

	class Eight_Paper_Welcome {
			...
			public function __construct( $plugins, $strings ) {
				...
				$this->tab_sections = array(
					'getting_started' => esc_html__('Getting Started', 'eight-paper'),
					'recommended_plugins' => esc_html__('Recommended Plugins', 'eight-paper'),
					//'actions_required' => esc_html__('Required Plugins', 'eight-paper'),
					'demo_import' => esc_html__('Import Demo', 'eight-paper'),
					'support' => esc_html__('Support', 'eight-paper'),
					'changelog' => esc_html__('Changelog', 'eight-paper'),
					'more_wp' => esc_html__('More WordPress Stuff', 'eight-paper'),
				);
			...
			public function welcome_admin_notice_display(){
				...
				$eight_paper_an_div = '
				<div class="updated eight-paper-an notice notice-success is-dismissible">
				%1$s
				<hr/>
				<div class="eight-paper-column-wrap">
				<div class="eight-paper-column col-img">%2$s</div>
				<div class="eight-paper-column col-demos">%3$s</div>
				<div class="eight-paper-column col-doc">%4$s</div>
				</div> 
				</div>
				<style>%5$s</style>';

				/* translators: 1 - notice title, 2 - notice message */
				$eight_paper_an_top = sprintf(
					'<h2>%1$s</h2><p class="about-desc">%2$s</p></hr>',
					esc_html__( 'Congratulations!', 'eight-paper' ),
					sprintf(
						/* translators: %s - theme name */
						esc_html__( '%s is now installed and ready to use. We\'ve assembled some links to get you started.', 'eight-paper' ),
						$this->theme_name
					)
				);

				$eight_paper_an_btn = sprintf(
					/* translators: 1 - url, 2 - button text */
					'<a href="%1$s" class="button button-primary eight-paper-btn" >%2$s</a>',
					esc_url( admin_url( 'themes.php?page=welcome-page#demo_import' ) ),
					esc_html__( 'Try one of our ready to use Starter Sites', 'eight-paper' )
				);
				$eight_paper_an_pbtn = sprintf(
					...
					esc_html__( 'or go to the theme settings', 'eight-paper' )
				);
				$eight_paper_an_img = sprintf(
					'<picture>
				...
				$eight_paper_an_list = sprintf(
					'<div><h3><span class="dashicons dashicons-images-alt2"></span> %1$s</h3><p>%2$s</p></div><div> <p>%3$s</p><p>%4$s</p> </div>',
					__( 'Sites Library', 'eight-paper' ),
					// translators: %s - theme name
					sprintf( esc_html__( '%s now comes with a sites library with various designs to pick from. Visit our collection of demos that are constantly being added.', 'eight-paper' ), $this->theme_name ),
					$eight_paper_an_btn,
					$eight_paper_an_pbtn
				);
				$eight_paper_an_doc = sprintf(
					'<div><h3><span class="dashicons dashicons-format-aside"></span> %1$s</h3><p>%2$s</p><a class="button eight-paper-btn" href="%3$s">%4$s</a></div><div></div>',
					__( 'Documentation', 'eight-paper' ),
					// translators: %s - theme name
					sprintf( esc_html__( 'Need more details? Please check our full documentation for detailed information on how to use %s.', 'eight-paper' ), $this->theme_name ),
					'https://8degreethemes.com/documentation/eight-paper',
					esc_html__( 'Read full documentation', 'eight-paper' )
				);
				$eight_paper_an_style = '
				.eight-paper-an.notice.is-dismissible {padding: 20px 15px 5px;}
				.eight-paper-an hr {margin: 20px -23px 0;border-top: 1px solid #f3f4f5;border-bottom: none;}
				.eight-paper-an h3{margin: 17px 0 0;font-size: 16px;line-height: 1.4;}
				.eight-paper-an p {color: #72777c;}
				.eight-paper-an h2{margin: 0;font-size: 21px;font-weight: 400;line-height: 1.2;}
				.eight-paper-an p.about-desc{color: #72777c;font-size: 16px;margin: 0;padding:0px;}
				.eight-paper-column-wrap {display: -ms-grid;display: grid;-ms-grid-columns: 24% 32% 32%;grid-template-columns: 24% 32% 32%;margin-bottom: 13px;}
				.eight-paper-column {padding: 20px 40px 0 0;}
				.eight-paper-an .eight-paper-btn {padding: 30px;line-height: 0;}';
				...
				<div class="wrap about-wrap access-wrap">					
					<div class="top-block-wrap">					
						<div class="about-text">
							<h1><?php /* translators: %1$s: theme name, %2$s: theme version */ printf( esc_html__( 'Welcome to %1$s - Version %2$s', 'eight-paper' ), esc_html($this->theme_name), esc_html($this->theme_version) ); ?></h1>
						...
						<div class="welcome-section-wrapper is_loading">
							...
							<div class="notice-sidebar is_loading">
								<div class= "notice-sidebar-item">
									<h4><?php echo esc_html('Join in our social networks!','eight-paper') ?></h4>
									<p><?php echo esc_html__('Get connected, share your opinions and more via our social community:', 'eight-paper'); ?></p>
									<p><a href="<?php echo esc_url('https://www.facebook.com/8DegreeThemes');?>"><?php echo esc_html('Join our Facebook Group','eight-paper') ?></a> <?php echo esc_html('- to receive updates, offers and more.','eight-paper') ?></p>
									<p><a href="<?php echo esc_url('https://www.youtube.com/8degreethemes');?>"><?php echo esc_html('Subscribe our YouTube Channel','eight-paper') ?></a> <?php echo esc_html('- for tutorials, videos and more.','eight-paper') ?></p>
									<p><a href="<?php echo esc_url('https://www.twitter.com/8degreethemes');?>"><?php echo esc_html('Follow us on Twitter','eight-paper') ?></a> <?php echo esc_html('- to stay updated.','eight-paper') ?></p>
								</div>
								<div class= "notice-sidebar-item">
									<h4><?php echo esc_html('Leave us a review','eight-paper') ?></h4>
									<p><?php echo esc_html__('Are you are enjoying Eight Paper? We would love to hear your feedback.', 'eight-paper'); ?></p>
									<a href="<?php echo esc_url('https://wordpress.org/support/theme/eight-paper/');?>"><?php echo esc_html('Submit a review','eight-paper') ?></a>
			...
			public function plugin_installer_callback(){
				...
				if ( ! current_user_can('install_plugins') ) {
					wp_die( esc_html__( 'Sorry, you are not allowed to install plugins on this site.', 'eight-paper' ) );
				}
				...
				if (! wp_verify_nonce( $nonce, 'plugin_installer_nonce' )) {
					wp_die( esc_html__( 'Error - unable to verify nonce, please try again.', 'eight-paper') );
				}
			...
			public function plugin_activation_callback() {
				...
				if(file_exists($plugin_file)) {
					...
					echo esc_html__('Plugin Does not Exists' , 'eight-paper');
				}
